...
namespace WebAPI___Toriq_Mardlatillah.Migrations
{
    /// <inheritdoc />
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 11, 5, 0, 0, 0, 0, DateTimeKind.Utc), "Andi", 1200 },
                    { 2, new DateTime(2025, 11, 5, 0, 0, 0, 0, DateTimeKind.Utc), "Nadia", 980 }
                });
